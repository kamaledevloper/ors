...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.submitvalue = function (val) {
        this.sam = val.value;
    ...
    AppComponent.prototype.showBlock = function (data) {
...
/* harmony import */ var _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! @ngx-translate/http-loader */ "./node_modules/@ngx-translate/http-loader/fesm5/ngx-translate-http-loader.js");
...
var BaseListCtl = /** @class */ (function (_super) {
    ...
    BaseListCtl.prototype.delete = function (id) {
        _super.prototype.delete.call(this, id);
    };
...
var BaseCtl = /** @class */ (function () {
    ...
    BaseCtl.prototype.delete = function (id) {
        var _self = this;
...
var CollegeListComponent = /** @class */ (function (_super) {
    ...
    function CollegeListComponent(servicelocator, router) {
        var _this = _super.call(this, servicelocator.endpointService.COLLEGE, servicelocator, router) || this;
...
var CollegeComponent = /** @class */ (function (_super) {
    ...
    function CollegeComponent(serviceLocator, route) {
        var _this = _super.call(this, serviceLocator.endpointService.COLLEGE, serviceLocator, route) || this;
        _this.serviceLocator = serviceLocator;
        _this.route = route;
        return _this;
    }
...
var CourseListComponent = /** @class */ (function (_super) {
    ...
    function CourseListComponent(serviceLOcator, route) {
        return _super.call(this, serviceLOcator.endpointService.COURSE, serviceLOcator, route) || this;
    }
...
var CourseComponent = /** @class */ (function (_super) {
    ...
    function CourseComponent(serviceLocator, router) {
        return _super.call(this, serviceLocator.endpointService.COURSE, serviceLocator, router) || this;
    }
...
var FacultyListComponent = /** @class */ (function (_super) {
    ...
    function FacultyListComponent(serviceLocator, route) {
        return _super.call(this, serviceLocator.endpointService.FACULTY, serviceLocator, route) || this;
    }
...
var FacultyComponent = /** @class */ (function (_super) {
    ...
    function FacultyComponent(serviceLocator, router) {
        var _this = _super.call(this, serviceLocator.endpointService.FACULTY, serviceLocator, router) || this;
        _this.serviceLocator = serviceLocator;
        return _this;
    }
...
var HttpServiceService = /** @class */ (function () {
    function HttpServiceService(router, httpClint, cookie) {
        this.router = router;
    ...
    HttpServiceService.prototype.get = function (endpoint, callback) {
        ...
        return _self.httpClint.get(endpoint, { withCredentials: true }).subscribe(function (data) {
    ...
    HttpServiceService.prototype.post = function (endpoint, bean, callback) {
        ...
        return _self.httpClint.post(endpoint, bean, { withCredentials: true }).subscribe(function (data) {
...
var MarksheetListComponent = /** @class */ (function (_super) {
    ...
    function MarksheetListComponent(servceLocator, route) {
        var _this = _super.call(this, servceLocator.endpointService.MARKSHEET, servceLocator, route) || this;
        _this.servceLocator = servceLocator;
        _this.route = route;
        return _this;
    }
...
var MarksheetComponent = /** @class */ (function (_super) {
    ...
    function MarksheetComponent(serviceLocator, route) {
        var _this = _super.call(this, serviceLocator.endpointService.MARKSHEET, serviceLocator, route) || this;
        _this.serviceLocator = serviceLocator;
        _this.route = route;
        return _this;
    }
...
var NavComponent = /** @class */ (function () {
    function NavComponent(transalate, cookie, serviceLocator, endpoint) {
...
var PageNotFoundComponent = /** @class */ (function (_super) {
    ...
    function PageNotFoundComponent(servicelocator, route, httpclint) {
        var _this = _super.call(this, servicelocator.endpointService.USER, servicelocator, route) || this;
        _this.servicelocator = servicelocator;
        _this.route = route;
        _this.httpclint = httpclint;
...
var RoleListComponent = /** @class */ (function (_super) {
    ...
    function RoleListComponent(serviceLocator, route) {
        return _super.call(this, serviceLocator.endpointService.ROLE, serviceLocator, route) || this;
    }
...
var RoleComponent = /** @class */ (function (_super) {
    ...
    function RoleComponent(serviceLocator, route) {
        var _this = _super.call(this, serviceLocator.endpointService.ROLE, serviceLocator, route) || this;
        _this.serviceLocator = serviceLocator;
        _this.route = route;
        return _this;
    }
...
var StudentListComponent = /** @class */ (function (_super) {
    ...
    function StudentListComponent(serviceLocator, route) {
        var _this = _super.call(this, serviceLocator.endpointService.STUDENT, serviceLocator, route) || this;
        _this.serviceLocator = serviceLocator;
        _this.route = route;
        return _this;
    }
...
var StudentComponent = /** @class */ (function (_super) {
    ...
    function StudentComponent(serviceLocator, route) {
        return _super.call(this, serviceLocator.endpointService.STUDENT, serviceLocator, route) || this;
    }
...
var SubjectListComponent = /** @class */ (function (_super) {
    ...
    function SubjectListComponent(serviceLOcator, router) {
        var _this = _super.call(this, serviceLOcator.endpointService.SUBJECT, serviceLOcator, router) || this;
        _this.serviceLOcator = serviceLOcator;
        _this.router = router;
        return _this;
    }
...
var SubjectComponent = /** @class */ (function (_super) {
    ...
    function SubjectComponent(serviceLocator, router) {
        return _super.call(this, serviceLocator.endpointService.SUBJECT, serviceLocator, router) || this;
    }
...
var TimeTableListComponent = /** @class */ (function (_super) {
    ...
    function TimeTableListComponent(serviceLocator, router) {
        return _super.call(this, serviceLocator.endpointService.TIMETABLE, serviceLocator, router) || this;
    }
...
var TimetableComponent = /** @class */ (function (_super) {
    ...
    function TimetableComponent(servicelocator, route) {
        var _this = _super.call(this, servicelocator.endpointService.TIMETABLE, servicelocator, route) || this;
        _this.servicelocator = servicelocator;
        _this.route = route;
        return _this;
    }
...
var ChangePasswordComponent = /** @class */ (function (_super) {
    ...
    function ChangePasswordComponent(service, route, httpclint) {
        var _this = _super.call(this, service.endpointService.USER, service, route) || this;
...
var MyProfileComponent = /** @class */ (function (_super) {
    ...
    function MyProfileComponent(service, route, httpclint) {
        var _this = _super.call(this, service.endpointService.User, service, route) || this;
        _this.service = service;
        _this.route = route;
        _this.httpclint = httpclint;
...
var UserListComponent = /** @class */ (function (_super) {
    ...
    function UserListComponent(serviceLocator, router) {
        var _this = _super.call(this, serviceLocator.endpointService.USER, serviceLocator, router) || this;
        _this.serviceLocator = serviceLocator;
        _this.router = router;
        return _this;
    }
...
}(src_app_base_list_component__WEBPACK_IMPORTED_MODULE_2__["BaseListCtl"]));
...
var UserComponent = /** @class */ (function (_super) {
    ...
    function UserComponent(servicelocator, route, httpclint) {
        var _this = _super.call(this, servicelocator.endpointService.USER, servicelocator, route) || this;
        _this.servicelocator = servicelocator;
        _this.route = route;
        _this.httpclint = httpclint;
...
}(src_app_base_component__WEBPACK_IMPORTED_MODULE_4__["BaseCtl"]));
